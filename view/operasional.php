                        ...
                        <tr>
                            ...
                            <td>
                                <div class="d-flex gap-2">
                                    <button class="btn btn-sm btn-edit" data-bs-toggle="modal" data-bs-target="#modalEdit"
                                    ...
                                    <a href="?hapus=<?= $row['id_operasional'] ?>" onclick="return confirm('Yakin ingin hapus?')" class="btn btn-sm btn-delete">🗑️</a>
                                </div>
                            </td>
                        </tr>
                    <?php } ?>
